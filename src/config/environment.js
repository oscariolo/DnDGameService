...
const env = {
    ...
    // MongoDB
    MONGO_URI: process.env.MONGO_URI || 'mongodb://admin:adminpassword@mongodb:27017/dnd_game_service?authSource=admin',
    MONGO_DB_NAME: process.env.MONGO_DB_NAME || 'dnd_game_service',

    // Spring Boot Backend
    SPRINGBOOT_AUTH_URL: process.env.SPRINGBOOT_AUTH_URL || 'http://dndspringbackend:8080/api/auth',
